...
<a href="/test/offers/create"class="btn login-btn shadow">
<i class="fa fa-plus">عرض عقار</i>
</a>
</div>
...
<div class="col-lg-3">
    <a href="/test/offers/{{$item->id}}"><button class="btn more2-btn">التفاصيل </button></a>

    <form action="{{action('front\OffersController@destroy',$item->id)}}" method="post">
      
         
          <a href='/test/offers/{{$item->id}}/edit' class="btn btn-success">edit</a>
           @csrf
           @method('DELETE')
