...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form action="{{action('front\OffersController@update',$item->id)}}" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="space" class="form-control" value="{{$item->space}}"/>
                <br>
                <label> <h3>عدد الغرف</h3></label>
                <input type="text" name="rooms" class="form-control" value="{{$item->rooms}}"/>
                <br>
                <br>
