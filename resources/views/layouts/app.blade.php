...
<header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>EL</b>Safa</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>El</b>Safa</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Mohamed </span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="">
          <a href="/dashboard/governments">
            <i class="fa fa-dashboard"></i> <span>Governments</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
      ...
      <li class="">
        ...
        <li class="">
          <a href="/dashboard/contacts">
            <i class="fa fa-message"></i> <span>Contats</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <li class="">
          <a href="/dashboard/users">
            <i class="fa fa-message"></i> <span>Users</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <li class="">
          <a href="/dashboard/roles">
            <i class="fa fa-message"></i> <span>Roles</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <li class="">
          <a href="/dashboard/permissions">
            <i class="fa fa-message"></i> <span>Permissions</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
